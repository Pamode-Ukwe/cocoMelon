        ...
        <header className="text-main-black sticky top-0 bg-white z-50">
            ...
            <div className="py-5 md:px-10 px-12 flex md:justify-between mt-6">
                ...
                <div className="flex gap-4 sm:ml-[55%] md:ml-0 ml-[35%]">
                    ...
                    <button onClick={swap} className="flex"><BiCart className="w-8 h-8 outline rounded-full outline-gray-300/30 outline-2 p-1 relative" title="cart"/>
                    <p className="bg-black text-white absolute rounded-3xl px-1 ml-5 text-xs">10</p></button>
                </div>
            </div>
            {/* Ad */}
